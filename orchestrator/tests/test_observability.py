...
class TestMetricsExist:
    def test_ingestion_duration_metric(self):
        from orchestrator.app.observability import INGESTION_DURATION

        assert INGESTION_DURATION is not None

    def test_llm_extraction_duration_metric(self):
        from orchestrator.app.observability import LLM_EXTRACTION_DURATION

        assert LLM_EXTRACTION_DURATION is not None

    def test_neo4j_transaction_duration_metric(self):
        from orchestrator.app.observability import NEO4J_TRANSACTION_DURATION

        assert NEO4J_TRANSACTION_DURATION is not None

    def test_query_duration_metric(self):
